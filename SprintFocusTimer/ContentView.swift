...
struct MenuBarView: View {
    ...
    var body: some View {
        ...
        .frame(minWidth: 244, idealWidth: 244, maxWidth: .infinity, minHeight: 348, idealHeight: 348, maxHeight: .infinity)
    ...
    func timerDiameter(for size: CGSize) -> CGFloat {
        let availableDiameter = min(size.width - 48, size.height - 212)
